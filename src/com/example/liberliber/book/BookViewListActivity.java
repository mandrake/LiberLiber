...
public class BookViewListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.book_view_list_activity);
        
        mProgressBar = (ProgressBar)findViewById(R.id.book_view_list_progbar);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = null;
        i = new Intent(this, BookViewEntryActivity.class);

        Log.w("BVBLA", m.get("title"));
        Log.w("BVBLA", m.get("author"));
    ...
    private class ParseEntries extends AsyncTask
        ...
        protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            ...
            la = new SimpleAdapter(
                    BookViewListActivity.this, result,
