...
public class MusicViewListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_view_list_activity);
        
        mProgressBar = (ProgressBar)findViewById(R.id.music_view_list_progbar);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = null;
        i = new Intent(this, MusicViewEntryActivity.class);
    ...
    private class ParseEntries extends AsyncTask
        ...
        protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            ...
            la = new SimpleAdapter(
                    MusicViewListActivity.this, result,
        ...
        protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
            ArrayList<HashMap<String, String>> music = new ArrayList<HashMap<String, String>>();
            ...
            try {
                ...
                for (Element currbook : e.getElementsByTag("table")) {
                    ...
                    Element trMusic = content.getElementsByTag("tr").get(7);
                    
                    Element tdTitle = trTitle.getElementsByTag("td").get(2);
                    Element tdMusic = trMusic.getElementsByTag("td").get(1);
                    
                    m.put("title", tdTitle.text());
                    m.put("html", tdMusic.html());
